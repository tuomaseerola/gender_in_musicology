...
#ggsave(here('figures','figure_country_oddsratios.png'),g1,width=8,height=6)
ggsave(here('figures','figure_country_oddsratios_14.png'),g1,width=8,height=6)
